...
class ChartsListAdapter(val onChartClickListener: OnChartClickListener,val onChartLongClickListener: OnChartLongClickListener): RecyclerView.Adapter<ChartsListAdapter.ViewHolder>() {
